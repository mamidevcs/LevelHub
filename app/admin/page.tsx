...
export default function AdminPage() {
  // Aktif sekme durumu: "users" veya "tags"
  ...
  // Etiket ekleme mesajı (başarı veya hata)
  ...
  async function changeRole(userId, newRole) {
    ...
    else alert("Rol güncellenirken hata oluştu");
  }
  ...
  async function deleteTag(id) {
    ...
    const data = await res.json();
    if (res.ok) fetchTags();
    else alert(data.error || "Etiket silinirken hata oluştu");
  }

  // Sekme değişiminde ilgili veriyi çek
  useEffect(() => {
